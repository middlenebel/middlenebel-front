...
@NgModule({
  declarations: [
    ...
    ElementDirective, ChildsDirective, NextDirective, ViewerDirective, WatcherDirective, QuestionDirective,
    ItemCoreComponent, 
    ItemPlatformComponent, ItemDockerComponent, MoskisChildComponent, ItemK8sComponent, ViewerComponent, LoggerComponent, BrowserComponent, 
